...
public class SubjectRepositoryImpl extends BaseRepositoryImpl implements SubjectRepository {
    ...
    public List<Subject> getAll() {
        ...
        liste = entityManager.createNamedQuery("get-all-subjet",Subject.class).getResultList();
        return liste;
    }
    ...
    public Collection<Teacher> findTeachers(Long id) {
        ...
        return entityManager.createNamedQuery("Subject.findTeachers",Teacher.class)
        .setParameter("id", id)
        .getResultList();
    }
}
